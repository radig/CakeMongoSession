 ...
 * PHP versions 5
 *
 * Copyright 2011, Radig Soluções em TI. (http://radig.com.br)
 *
 * Licensed under The MIT License
 * Redistributions of files must retain the above copyright notice.
 *
 * @copyright     Copyright 2011, Radig Soluções em TI. (http://radig.com.br)
 * @link          http://radig.com.br/opensource Radig OpenSource Projects
 * @package       cake_mongo_session
 * @license       MIT License (http://www.opensource.org/licenses/mit-license.php)
 */
if (!class_exists('CakeMongoSession'))
{
	App::import('Lib', 'CakeMongoSession.CakeMongoSession');
}

/**
 * Session Component.
 *
 * Session handling from the controller, using MongoDB as backend.
 *
 */
class SessionComponent extends CakeMongoSession {
 ...
 * Class constructor
 *
 * @param array $base The base path for the Session
 */
